...
from .dkd import DKD, rcnn_dkd_loss
...
class ReviewDKD(RCNNKD):
    ...
    def forward(self, batched_inputs: Tuple[Dict[str, torch.Tensor]]):
        ...
        losses['loss_reviewkd'] = hcl(s_features_flat_trans, t_features_flat) * self.kd_args.REVIEWKD.LOSS_WEIGHT
