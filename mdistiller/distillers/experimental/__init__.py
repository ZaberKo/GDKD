...
CFG.LS_GDKD = CN()
CFG.LS_GDKD.CE_WEIGHT = 1.0
CFG.LS_GDKD.KD_WEIGHT = 1.0
CFG.LS_GDKD.W0 = 1.0
CFG.LS_GDKD.W1 = 1.0
CFG.LS_GDKD.W2 = 8.0
CFG.LS_GDKD.TOPK = 5
CFG.LS_GDKD.STRATEGY = "best" # or "worst"
CFG.LS_GDKD.KL_TYPE = "forward"
CFG.LS_GDKD.T = 4.0
CFG.LS_GDKD.WARMUP = 20
CFG.LS_GDKD.NORM_MODE = "global"