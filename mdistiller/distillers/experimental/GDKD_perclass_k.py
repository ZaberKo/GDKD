...
class GDKDPerClassK(Distiller):
    """
        GDKD with autok: k is determined by the teacher's logits on each class,
        which is controled by prebuild_topk_th and prebuild_ratio_th.
        K is calculated on the average of the teacher's probs per class,
        based on the training set.
    """
    def __init__(self, student, teacher, cfg):
        super(GDKDPerClassK, self).__init__(student, teacher)
        self.ce_loss_weight = cfg.GDKDPerClassK.CE_WEIGHT
        self.w0 = cfg.GDKDPerClassK.W0
        self.w1 = cfg.GDKDPerClassK.W1
        self.w2 = cfg.GDKDPerClassK.W2
        self.temperature = cfg.GDKDPerClassK.T
        self.warmup = cfg.GDKDPerClassK.WARMUP
        self.kl_type = cfg.GDKDPerClassK.KL_TYPE

        self.prebuild_topk_th = cfg.GDKDPerClassK.PREBUILD_TOPK_TH
        self.prebuild_ratio_th = cfg.GDKDPerClassK.PREBUILD_RATIO_TH
        self.prebuild_path = cfg.GDKDPerClassK.PRELOAD_TOPK_PATH
        ...
        if self.prebuild_path:
            ...
            # TODO: save topk_arr into yaml to support PRELOAD_TOPK_PATH
